...
│
├── docs/onboarding/START_HERE.md   ← you are reading this
├── docs/guides/DEV_GUIDE.md        ← how to run, test, contribute
├── docs/guides/PRODUCT_GUIDE.md    ← what products exist and how they relate
├── docs/architecture/ARCH_OVERVIEW.md ← system mental model and flows
│
...
├── specs/products/        ← product definitions (docs, scope, vision—not runtime code)
...
4. **Products are additive**  
   The `specs/products/` directory is mostly documentation and scope. Adding a product = adding a folder under `specs/products/` and, when needed, domain slices in the API and demo routes in the UI. No big-bang refactor.
...
2. **Skim** [ARCH_OVERVIEW.md](../architecture/ARCH_OVERVIEW.md) for the layered view and flows (5–10 minutes).
3. **Run the system** using [DEV_GUIDE.md](../guides/DEV_GUIDE.md): install deps, start API, start UI, open the app.
...
- **specs/reports/**, **benchmarks/**, **specs/versioning/**—come back when you need them.
- **DEPENDENCY_GRAPH.md**, **ARCHITECTURE_MAP.md**—reference only; use docs/architecture/ARCH_OVERVIEW.md for the mental model.
...
| Understand products and demos | PRODUCT_GUIDE.md, specs/products/*/README.md |
...
| Understand engine contracts | engine-core/src/interfaces/, specs/contracts/ |
| Add or evolve a product | specs/products/ (new folder + docs), then API/UI as needed |
| See detailed architecture | ARCHITECTURE_MAP.md, DEPENDENCY_GRAPH.md |
| See CI/CD, quality, release | docs/engineering/, specs/quality/, specs/release/ |
...
- **Product:** specs/products/—what we build for users; product docs and scope.
- **SaaS / Monetization / Platform / Enterprise:** Built on top of the gateway and engines; don’t replace core or engines.

You’re ready to open [DEV_GUIDE.md](../guides/DEV_GUIDE.md) and run the system, or [ARCH_OVERVIEW.md](../architecture/ARCH_OVERVIEW.md) to lock in the mental model. Welcome aboard.
