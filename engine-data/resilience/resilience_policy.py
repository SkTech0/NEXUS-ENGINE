"""
Engine Data — Resilience policy (ERL-4).
Retries with backoff, timeouts, safe failure.
"""
...
def with_retry(
    ...
    """Decorator: retry with backoff. Default retryable: DependencyError, TimeoutError."""
    ...
    def _retryable(e: Exception) -> bool:
        ...
        return name in pol.retryable_errors
...
def with_timeout(timeout_ms: float, operation: str = "") -> Callable[[Callable[..., T]], Callable[..., T]]:
    """Decorator: run with timeout. Sync: runs fn; for true timeout use async or threading in engines."""
...
class ResiliencePolicy:
    """Holds retry and timeout config; use with_retry / with_timeout for execution."""
