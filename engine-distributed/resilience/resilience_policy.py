"""
Engine Distributed — Resilience policy (ERL-4).
Retries, timeouts, network fault handling.
"""
...
class RetryPolicy:
    ...
    retryable_errors: tuple[str, ...] = ("DependencyError", "TimeoutError", "ExecutionError", "NetworkError", "PartitionError")
