"""
Engine Distributed — Error model (ERL-4).
Network/partition errors, unified mapping, non-crashing handling.
"""
...
ERROR_CODES = ("VALIDATION", "ENGINE", "DEPENDENCY", "TIMEOUT", "EXECUTION", "NETWORK", "PARTITION")
ERROR_TYPES = ("ValidationError", "EngineError", "DependencyError", "TimeoutError", "ExecutionError", "NetworkError", "PartitionError")
...
class PartitionError(BaseEngineError):
    code = "PARTITION"
    type = "PartitionError"
    retryable = True
