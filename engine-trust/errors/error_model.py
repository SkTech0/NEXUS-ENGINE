"""
Engine Trust — Error model (ERL-4).
Verification error models, unified mapping, non-crashing handling.
"""
...
ERROR_CODES = ("VALIDATION", "ENGINE", "DEPENDENCY", "TIMEOUT", "EXECUTION", "VERIFICATION")
ERROR_TYPES = ("ValidationError", "EngineError", "DependencyError", "TimeoutError", "ExecutionError", "VerificationError")
...
class VerificationError(BaseEngineError):
    code = "VERIFICATION"
