/**
 * Orchestration-layer service discovery.
...
const DEFAULT_HOST = process.env['ORCHESTRATION_UPSTREAM_HOST'] || 'localhost';
...
export const SERVICE_NAMES = Object.keys(DEFAULT_PORTS) as string[];
